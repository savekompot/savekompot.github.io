...
world  = { 
    ...
    newGame: function() {
        var newGamePopup = new Messi('Компот! Школота хочет украсть у тебя тот самый священный ботинок, который несёт справедливость.<br/><br/> Защити ботинок и убей всю школоту, прыгая на неё.<br/><br/>Управление: стрелочки и WSD для перемещения, пробел для прыжка, enter для новой игры и R чтобы включить/выключить музыку.',
